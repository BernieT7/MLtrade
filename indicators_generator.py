...
df["delta price"] = df["log price"] - df["log price"].shift(1)
...
indicators = df[["order imbalance", "macd signal", "log spread", "mid price", "delta price", "delta volume", "log ADX", "obv", "RSI", "open interest", "vol", "future 10t return", "ATR%"]]

indicators.to_csv("training_indicators5_log.csv", index=False)
